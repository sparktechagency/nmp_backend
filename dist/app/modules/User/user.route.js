...
router.patch("/update-my-profile", (0, AuthMiddleware_1.default)(user_constant_1.UserRole.super_admin, user_constant_1.UserRole.user, user_constant_1.UserRole.user, user_constant_1.UserRole.admin), upload_1.default.single('file'), (0, validationMiddleware_1.default)(user_validation_1.updateProfileValidationSchema), user_controller_1.default.editMyProfile);
